...
export default function Team() {
  ...
  const goal = {
    ...
    1: {
      ...
      content:
        '이러한 인재들이 모인 에이네 팀은 명분 없는 형식을 지속적으로 없애고, 훌륭한 동료의 자극과 회사의 성장으로부터 스스로의 사명감을 세워갑니다',
    },
    2: {
      imgSrc:
      ...
      content:
        '내가 이 일을 왜 하는가를 계속해서 질문하며, 내 손으로 시장을 혁신하는 일, 그 과정에서 최고의 동료와 함께 하는 것이 자랑스러운 사람들, 에이네는 이런 분들과 함께 성장하고자 합니다.',
    },
  };
  ...
  return (
    ...
    >
      ...
      <div className="semi-overlay-image">
        <img className="team__image" src="../static/images/team/team_img-2.jpg" alt="" />
      </div>
